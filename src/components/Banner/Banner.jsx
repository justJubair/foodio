...
const Banner = () => {
    return(
        // main container
        <div className="flex flex-col items-center justify-center  bg-gradient-to-b from-orange-400 to-yellow-500 rounded-3xl my-6 pt-4 px-4 lg:px-0 md:flex-row mb-20 lg:mb-24">
             {/* text content */}
